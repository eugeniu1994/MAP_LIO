...
public:
    ...
    std::string lid_topic, imu_topic, gnss_topic, vux_topic = "/vux_data";
    ...
    std::deque<sensor_msgs::PointCloud2ConstPtr> vux_buffer;
    ...
    void vux_cbk(const sensor_msgs::PointCloud2::ConstPtr &msg);
